...
if %ERRORLEVEL% equ 0 (
    start "" pythonw "%~dp0usb4000_gui.py"
    exit /b 0
)

REM Varsayılan Python yollarını dene
if exist "C:\Program Files\Python310\pythonw.exe" (
    start "" "C:\Program Files\Python310\pythonw.exe" "%~dp0usb4000_gui.py"
    exit /b 0
)

if exist "C:\Program Files (x86)\Python310\pythonw.exe" (
    start "" "C:\Program Files (x86)\Python310\pythonw.exe" "%~dp0usb4000_gui.py"
    exit /b 0
)
...
if exist "%LOCALAPPDATA%\Programs\Python\Python310\pythonw.exe" (
    start "" "%LOCALAPPDATA%\Programs\Python\Python310\pythonw.exe" "%~dp0usb4000_gui.py"
    exit /b 0
)

if exist "C:\Python310\pythonw.exe" (
    start "" "C:\Python310\pythonw.exe" "%~dp0usb4000_gui.py"
    exit /b 0
)
